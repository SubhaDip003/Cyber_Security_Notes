...
```bash
SubhaDip03@htb[/htb]$ git clone https://github.com/thewhiteh4t/FinalRecon.git
SubhaDip03@htb[/htb]$ cd FinalRecon
SubhaDip03@htb[/htb]$ pip3 install -r requirements.txt
SubhaDip03@htb[/htb]$ chmod +x ./finalrecon.py
SubhaDip03@htb[/htb]$ ./finalrecon.py --help
